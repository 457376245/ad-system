...
public enum ResultCodeEnum {
    ...
    ERROR_IS_EXISTS_USER(false,21009,"用户已存在!"),
    ERROR_NOT_EXISTS_PLAN(false,22001,"计划不存在"),
    ERROR_IS_EXISTS_PLAN(false,22002,"计划已存在"),
    ERROR_NOT_EXISTS_UNIT(false,23001,"单元不存在"),
    ERROR_IS_EXISTS_UNIT(false,23002,"单元已存在"),
